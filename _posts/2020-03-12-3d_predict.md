...
tags: [Machine Learning, Neural Network, Regression, Classification, Data Visualization, Data Science]
---
...
![](/img/3d_cover.png){:height="49%" width="49%"} ![](/img/3d_scatter.png){:height="49%" width="49%"}
...
This project won the first prize during the [6th annual Brown Datathon](https://browndata.org/datathon/). To see our final report, please follow this link [here](https://medium.com/@shiyu_liu/additive-manufacturing-melt-pool-physics-prediction-using-physical-simulation-data-5ab660100e18).
